...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(2,2))
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(3,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(4,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(5,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(6,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(7,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(8,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(9,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=c(10,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(2,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(3,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(4,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(5,2))
predict.nn <- compute(nn,test.nn[,1:11])
test.nn$rate0.03nodes5.2<-ifelse(predict.nn$net.result>0.5,1,0)
nn
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(6,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(7,2))
predict.nn <- compute(nn,test.nn[,1:11])
test.nn$rate0.03nodes7.2<-ifelse(predict.nn$net.result>0.5,1,0)
nn
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(8,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(9,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=c(10,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(2,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(3,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(4,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(5,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(6,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(7,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(8,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(9,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=c(10,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
#--------------------------------learning 0.003------------------------------------------------
##nn with learning 0.03 hidden 2 ******not converged
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(2,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(3,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(4,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(5,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(6,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(7,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(8,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(9,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=c(10,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(2,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
##nn with learning 0.01 hidden 3 ******not converged
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(3,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(4,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(5,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(6,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(7,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(8,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(9,2))
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=c(10,2))
predict.nn <- compute(nn,test.nn[,1:11])
