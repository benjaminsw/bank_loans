...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=2)
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=3)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=4)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=5)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=6)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=7)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=8)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=9)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.1, hidden=10)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=2)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=3)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=4)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=5)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=6)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=7)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=8)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=9)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.03, hidden=10)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=2)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=3)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=4)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=5)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=6)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=7)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=8)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=9)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.01, hidden=10)
predict.nn <- compute(nn,test.nn[,1:11])
...
#--------------------------------learning 0.003------------------------------------------------
##nn with learning 0.03 hidden 2 ******not converged
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=2)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=3)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=4)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=5)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=6)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=7)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=8)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=9)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.003, hidden=10)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=2)
predict.nn <- compute(nn,test.nn[,1:11])
...
##nn with learning 0.01 hidden 3 ******not converged
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=3)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=4)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=5)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=6)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=7)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=8)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=9)
predict.nn <- compute(nn,test.nn[,1:11])
...
nn <- neuralnet(f, data=train.nn, linear.output=F, stepmax= 1e+05, threshold=0.01, rep=5, algorithm='backprop', learningrate=0.001, hidden=10)
predict.nn <- compute(nn,test.nn[,1:11])
