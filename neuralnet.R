...
nn
table(test.nn$predict, test.nn$rate0.1nodes1)
#--------------------------------learning 0.1------------------------------------------------
...
nn
table(test.nn$predict, test.nn$rate0.1nodes2)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes3)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes4)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes5)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes6)
...
predict.nn <- compute(nn,test.nn[,1:11])
test.nn$rate0.1nodes7<-ifelse(predict.nn$net.result>0.5,"paid","defaulted")
nn
table(test.nn$predict, test.nn$rate0.1nodes7)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes8)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes9)
...
nn
table(test.nn$predict, test.nn$rate0.1nodes10)
#--------------------------------learning 0.03------------------------------------------------
...
nn
table(test.nn$predict, test.nn$rate0.03nodes2)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes3)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes4)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes5)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes6)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes7)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes8)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes9)
...
nn
table(test.nn$predict, test.nn$rate0.03nodes10)
#--------------------------------learning 0.01------------------------------------------------
...
nn
table(test.nn$predict, test.nn$rate0.01nodes2)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes3)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes4)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes5)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes6)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes7)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes8)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes9)
...
nn
table(test.nn$predict, test.nn$rate0.01nodes10)
#--------------------------------learning 0.003------------------------------------------------
##nn with learning 0.03 hidden 2 ******not converged
...
nn
table(test.nn$predict, test.nn$rate0.003nodes2)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes3)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes4)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes5)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes6)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes7)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes8)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes9)
...
nn
table(test.nn$predict, test.nn$rate0.003nodes10)
#--------------------------------learning 0.01------------------------------------------------
...
nn
table(test.nn$predict, test.nn$rate0.001nodes2)
##nn with learning 0.01 hidden 3 ******not converged
...
nn
table(test.nn$predict, test.nn$rate0.001nodes3)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes4)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes5)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes6)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes7)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes8)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes9)
...
nn
table(test.nn$predict, test.nn$rate0.001nodes10)
